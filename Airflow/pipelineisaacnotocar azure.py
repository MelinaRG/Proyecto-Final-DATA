...
product_cat_name=pd.read_csv("../Datasets/Datasets/product_category_name_translation.csv")
geolocation=pd.read_csv("../Datasets/Datasets/olist_geolocation_dataset.csv", dtype= {'geolocation_zip_code_prefix': str})
marketing=pd.read_csv("../Datasets/Datasets/olist_marketing_qualified_leads_dataset.csv")
closed_deals=pd.read_csv("../Datasets/Datasets/olist_closed_deals_dataset.csv")
sellers=pd.read_csv("../Datasets/Datasets/olist_sellers_dataset.csv",dtype={"seller_zip_code_prefix": str})
customers=pd.read_csv("../Datasets/Datasets/olist_customers_dataset.csv",dtype={"customer_zip_code_prefix": str})
orders=pd.read_csv("../Datasets/Datasets/olist_orders_dataset.csv")
payments=pd.read_csv("../Datasets/Datasets/olist_order_payments_dataset.csv")
reviews=pd.read_csv("../Datasets/Datasets/olist_order_reviews_dataset.csv")
products=pd.read_csv("../Datasets/Datasets/olist_products_dataset.csv")
items=pd.read_csv("../Datasets/Datasets/olist_order_items_dataset.csv")
...
def etl_geolocation(geolocation, sellers, customers):
    ...
    df_coord_estados = pd.read_csv('../Datasets/datasets_auxiliares/coordenadas_estados.csv',sep=';')
    df_coord_ciudades = pd.read_csv('../Datasets/datasets_auxiliares/coordenadas_ciudades.csv')
    br_info = pd.read_csv('../Datasets/datasets_auxiliares/br_info.csv')
